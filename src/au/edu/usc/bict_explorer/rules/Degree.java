...
public class Degree {
    ...
    private Map<String, Option> minors;
    private Map<String, Option> careers;
    ...
    public void setCourses(Map<String, Option> courses) {
        this.courses = courses;
    }
    public void setCareers(Map<String, Option> careers) {
        this.careers = careers;
    }
    public void setMinors(Map<String, Option> minors) {
        this.minors = minors;
    }
